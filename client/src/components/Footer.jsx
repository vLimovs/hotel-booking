            ...
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center gap-3 mt-4'>
                        {/* Instagram */}
                        <img src={assets.instagramIcon} alt="instagramIcon" className='w-6 h-6' />
                        {/* Facebook */}
                        <img src={assets.facebookIcon} alt="facebookIcon" className='w-6 h-6' />
                        {/* Twitter */}
                        <img src={assets.twitterIcon} alt="twitterIcon" className='w-6 h-6' />
                        {/* LinkedIn */}
                        <img src={assets.linkendinIcon} alt="linkendinIcon" className='w-6 h-6' />
                    </div>
                </div>
