...
const AddRoom = () => {
    ...
    return (
        <form>
            <Title align='left' font='outfit' title='Add Room' subTitle='Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, voluptatem maxime corporis natus iste ut a facere mollitia esse animi.' />
                ...
                {Object.keys(images).map((key) => (
                    <label htmlFor={`roomImage${key}`} key={key}>
                        <img
                            ...
                            src={images[key] ? URL.createObjectURL(images[key]) : assets.uploadArea} alt={`roomImage${key}`} />
